...
public class EmailService : IEmailService
{
    ...
    private string GenerateFinancialDepartmentInvoiceEmailBody(Event @event)
    {
        ...
        sb.AppendLine($"                    <td>?? {@event.StartDate:g} - {@event.EndDate:g}</td>");
        sb.AppendLine("                </tr>");
        ...
        sb.AppendLine("                <div class='detail-row'>");
        sb.AppendLine("                    <div class='detail-label'>Service Period:</div>");
        sb.AppendLine($"                    <div class='detail-value'>{@event.StartDate:d} - {@event.EndDate:d}</div>");
        sb.AppendLine("                </div>");
        sb.AppendLine("                <div class='detail-row'>");
        ...
        sb.AppendLine($"            <p>Invoice request sent on {DateTime.UtcNow:g} UTC</p>");
