...
public class UpdateCustomerCommandHandlerTests
{
    ...
    {
        // Arrange
        var customerDto = new CustomerDTO { Id = 1, FirstName = "John", LastName = "Doe", Email = "john@example.com", FactuurEmail = "billing@example.com" };
    ...
    {
        // Arrange
        var existingCustomer = new Customer { Id = 1, FirstName = "John", LastName = "Doe", Email = "old@example.com", FactuurEmail = "billing-old@example.com" };
        var conflictingCustomer = new Customer { Id = 2, FirstName = "Jane", LastName = "Smith", Email = "new@example.com", FactuurEmail = "billing-new@example.com" };
        var customerDto = new CustomerDTO { Id = 1, FirstName = "John", LastName = "Doe", Email = "new@example.com", FactuurEmail = "billing@example.com" };
        var command = new UpdateCustomerCommand(customerDto);
    ...
    {
        // Arrange
        var existingCustomer = new Customer { Id = 1, FirstName = "John", LastName = "Doe", Email = "john@example.com", FactuurEmail = "old-billing@example.com" };
        var customerDto = new CustomerDTO { Id = 1, FirstName = "John", LastName = "Updated", Email = "john@example.com", FactuurEmail = "new-billing@example.com" };
        var command = new UpdateCustomerCommand(customerDto);
        ...
        Assert.Equal("new-billing@example.com", result.FactuurEmail);
    ...
    {
        // Arrange
        var existingCustomer = new Customer { Id = 1, FirstName = "John", LastName = "Doe", Email = "john@example.com", FactuurEmail = "billing@example.com" };
        var customerDto = new CustomerDTO { Id = 1, FirstName = "John", LastName = "Doe", Email = "john@example.com", FactuurEmail = "billing@example.com" };
        var command = new UpdateCustomerCommand(customerDto);
